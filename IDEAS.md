...
| [6.126](docs/agent-log.md#6126-convergence-is-the-else-branch-and-the-fleets-dominant-reuse-mechanism-has-no-relation-of-its-own--defect-measured-fourth-kind-proposal-hypothesis-first-proposal-falsified) | `convergence` is the `else` branch, and vendoring has no relation of its own | defect measured, fourth-kind proposal hypothesis |
